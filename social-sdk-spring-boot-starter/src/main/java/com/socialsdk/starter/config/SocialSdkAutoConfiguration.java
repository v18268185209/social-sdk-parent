package com.socialsdk.starter.config;

import com.socialsdk.chrome.service.ChromeProvider;
import com.socialsdk.core.config.SocialConfig;
import com.socialsdk.core.provider.SocialProvider;
import com.socialsdk.starter.properties.SocialSdkProperties;
...
public class SocialSdkAutoConfiguration {
    ...
    public static class SocialProviderManager {
         ...
         * 获取指定平台的Provider
         */
        public SocialProvider getProvider(com.socialsdk.core.constant.SocialPlatform platform) {
            if (platform == null) {
                return null;
            }
